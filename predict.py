...
def main():
    ...
    try:
        ...
        print("Error: Scaling files (mean.npy, std.npy) not found. Run main.py or train.py first.")
        return
    ...
    print("Enter measurements for setosa or versicolor classification")
    ...
    print("\nResults:")
    print(f"Perceptron: {class_names[pred_p]} (Confidence: {conf_p:.2f})")
    print(f"SVM: {class_names[pred_svm]} (Confidence: {conf_svm:.2f})")
